...
All figures on the book chapter are all based on 1,000 simulation repetitions. To achieve exactlt the same output `nsim` should be set to 1000, although it is worth noting that this will require considerable running time. 
